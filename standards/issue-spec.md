...
- `/quality-review` — files deferred items, certifying only the severity-carrying ones (Critical/High/Medium), whose bodies it composes in the certifiable problem/outcome/criteria shape
