...
In a fleet this decays fast, because parallel sessions land adjacent work continuously and nothing detects the decay. Measured on JA 2026-08-20: JA-292 was certified naming six raw `Status` sites at specific lines and had two left by grooming — four fixed in the interim, two cited lines gone — and JA-410, certified hours earlier the same session, went stale within hours when a sibling merged into the file it names.
