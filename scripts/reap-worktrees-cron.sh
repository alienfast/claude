...
# shell environment, so set PATH explicitly: git/jq/python3/gh/linear typically live in /usr/bin,
...
# linear are SOFT: their absence just disables the PR / Linear evidence (the local merged check still
