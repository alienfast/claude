...
3. Synthesize the exploration results into relevant files, patterns, and dependencies — dispatch a follow-up `Explore` only for genuine gaps
4. Design a step-by-step implementation plan
5. Identify which tasks are independent (parallelizable) vs dependent (sequential)
6. Write the plan to the plan file specified in the plan-mode system message
